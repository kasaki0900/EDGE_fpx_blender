...
class EDGE:
    # EDGE类是实现整个神经网络的顶层类
    # 项目的大部分参数(除了train/test中用到的路径参数等)通过EDGE类向下层传播
    # 用户可以根据修改EDGE类参数值来改变训练/生成结果
    def __init__(
        self,
        feature_type,
        checkpoint_path="",
        ...
        # 默认使用jukebox预训练参数,可选baseline基础参数(具体在audio_extraction中定义实现)
        ...
        # 神经网络的主要结构--舞蹈解码和高斯扩散, 以及Adan优化器, 都在model包中实现
    ...
    def render_sample(
        ...
        # render方法用于生成一个演示视频(火柴人)测试发现启用render对运行速度影响非常大
